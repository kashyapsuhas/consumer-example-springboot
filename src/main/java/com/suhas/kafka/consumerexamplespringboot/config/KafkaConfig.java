package com.suhas.kafka.consumerexamplespringboot.config;
...
public class KafkaConfig{
    ...
    public ConsumerFactory<String, UserData> userConsumerFactory() {
        ...
        config.put(JsonDeserializer.TRUSTED_PACKAGES, "com.suhas.kafka.consumerexamplespringboot.model");
        config.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.suhas.kafka.consumerexamplespringboot.model.UserData");
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, UserData> userDataConcurrentKafkaListenerContainerFactory() {
